#!/bin/bash
# live status of round 2's pattern sweep - run once, or `watch -n 5 ./sweep_status_round2.sh` for a live dashboard

BENCH_DIR=~/bronko_benchmark/phastsim-run-round2
LOG_DIR=$BENCH_DIR/pattern_sweep_logs
RESULTS_DIR=~/bronko_benchmark/bronko-test/sweep_results_round2
NUM_JOBS=${1:-10}
